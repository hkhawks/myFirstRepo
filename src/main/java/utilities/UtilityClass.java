...
public class UtilityClass extends Base {
	...
	/**
	 * This method returns data and time as a string
	 * @return
	 */
	...
	/**
	 * This method will select the value from static Drropdown by visible value
	 * @param element
	 * @param text
	 */
	 ...
	 * @param value
	 */
	public static void selectByValeu(WebElement element, String value) {
		Select select = new Select(element);
