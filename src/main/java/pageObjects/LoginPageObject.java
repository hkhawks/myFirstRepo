...
public class LoginPageObject extends Base{
	...
	// we will implement PageFactory.initElements method to initialize the page elements
	...
	// this constructor will be used to initialize the webelements inside this POM class
